...
public class Sa2ts extends SaDepthFirstVisitor<Object> {
    ...
    public Object visit(SaDecTab node) {
        ...
        if (tableGlobale.getVar(identif) != null) return null;
    ...
    public Object visit(SaDecFonc node) {
        ...
        for (int i = 0; i < list.length() ; i++) {
            if (tableLocale.getVar(identif) != null) return null;
    ...
    public Object visit(SaAppel node) {
        ...
        return tableGlobale.getVar(identif);
    }
