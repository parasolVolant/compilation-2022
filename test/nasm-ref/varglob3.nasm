...
var2 :	resd	16	;variable globale
var1 :	resd	16	;variable globale
...
main :	push	ebp	;sauvegarde la valeur de ebp
	...
	mov	dword [var1+0],	10	;Affect
	mov	dword [var2+0],	34	;Affect
	mov	eax,	dword [var1+0]	;Write 1
	call	iprintLF	;Write 2
	mov	eax,	dword [var2+0]	;Write 1
	call	iprintLF	;Write 2
